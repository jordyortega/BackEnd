...
&nbsp;<asp:TextBox ID="txtTelefoon" runat="server"></asp:TextBox>
        <br />
        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtTelefoon" Display="Dynamic" ErrorMessage="Vul een geldig nummer in! Zoals: 074 2780013 of 0742780013" ValidationExpression="(((\d{3}) (\d{7}))|(\d{10}))"></asp:RegularExpressionValidator>
